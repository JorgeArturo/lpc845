...
- pin_list:
  ...
  - {pin_num: '10', peripheral: SWD, signal: SWDIO, pin_signal: SWDIO/PIO0_2, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '15', peripheral: USART1, signal: RXD, pin_signal: PIO0_16}
  - {pin_num: '22', peripheral: USART1, signal: TXD, pin_signal: PIO0_15}
  - {pin_num: '18', peripheral: USART2, signal: RXD, pin_signal: PIO0_26}
  - {pin_num: '17', peripheral: USART2, signal: TXD, pin_signal: PIO0_27}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitSWD_DEBUGPins(void)
{
    ...
    /* USART2_TXD connect to P0_27 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART2_TXD, kSWM_PortPin_P0_27);

    /* USART2_RXD connect to P0_26 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART2_RXD, kSWM_PortPin_P0_26);
