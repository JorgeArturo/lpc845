...
- name: BOARD_InitPeripherals
  UUID: 4d659896-4307-42fe-b2a0-14c12458a2f5
  ...
  - fsl_dma:
    ...
    - dma_channels:
      - 0:
        ...
        - trans_config:
          - init_callback: 'true'
          - callback_function: 'dma0_callback'
          - callback_user_data: ''
        - tcd_config:
          - 0:
            - tcdID: 'CH0_TCD0'
            ...
            - dstAddr:
              - addrType: 'startAddr'
              - addr_expr: '&DstAddress[0]'
              - addr_def: 'uint16_t DstAddress[10]'
...
extern uint16_t DstAddress[10];
AT_NONCACHEABLE_SECTION_ALIGN( dma_descriptor_t DMA0_CH0_TCDs_config[1], FSL_FEATURE_DMA_LINK_DESCRIPTOR_ALIGN_SIZE )
 = {
  {
    .xfercfg = DMA_CHANNEL_XFER(true, true, true, false, kDMA_Transfer16BitWidth, kDMA_AddressInterleave0xWidth, kDMA_AddressInterleave0xWidth, 2U),
    ...
    .dstEndAddr = (void *)DMA_DESCRIPTOR_END_ADDRESS(&DstAddress[0], (uint32_t)kDMA_AddressInterleave0xWidth, 2U, (uint32_t)kDMA_Transfer16BitWidth),
...
static void DMA0_init(void) {
  ...
  DMA_SetCallback(&DMA0_CH0_Handle, dma0_callback, NULL);
